...
models.2 = c(
           ...
           AICc(Arima(housing_ts,order=c(0,1,12))), #BEST
...
covFM = cov2cor(final.model$var.coef)
maxCovFM = max(covFM[covFM < 1])
print(paste0("Largest  correlation: ", maxCovFM))
...
covFM2 = cov2cor(final.model2$var.coef)
maxCovFM2 = max(covFM2[covFM2 < 1])
print(paste0("Largest  correlation: ", maxCovFM2))
...
final.model3 = Arima(housing_ts, order = c(2,1,12))
...
final.model3.mean = mean(final.model3$residuals)
print(paste0("Residual Mean: ", final.model3.mean))

print("")
print("")

covFM3 = cov2cor(final.model3$var.coef)
maxCovFM3 = max(covFM3[covFM3 < 1])
print(paste0("Largest  correlation: ", maxCovFM3))

print("")
print("")

jarque.bera.test(final.model3$residuals) 
...
final.model4 = Arima(housing_ts, order = c(3,1,12))
...
final.model4.mean = mean(final.model4$residuals)
print(paste0("Residual Mean: ", final.model4.mean))
...
covFM4 = cov2cor(final.model4$var.coef)
maxCovFM4 = max(covFM4[covFM4 < 1])
print(paste0("Largest  correlation: ", maxCovFM4))

print("")
print("")

jarque.bera.test(final.model4$residuals) 


plot(final.model4$residuals)
...
fcst.fm=forecast(final.model3, h=24)
plot(fcst.fm) #There is a problem with the data shape: it looks like residuals!

fcst.fm2=forecast(final.model4, h=24)
plot(fcst.fm2)
...
getrmse(housing_ts,h=12,order=c(2,1,12))

getrmse(housing_ts,h=12,order=c(3,1,12))
```
...
tsdisplay(residuals(final.model4), lag.max=15, main='Final Model 4 Residuals')
