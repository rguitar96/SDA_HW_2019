...
# #Lowest value appears to be p=3 d=1 q=3 with a value of: (371.2502)
 min(models)
 
```
  
However, because we know by observing the residuals that there is a spike in the 12th obvservation, we are also going to test using a p or q values equal to 12 to see if we get lower values than the 3 1 3 model.

(Nacho: Why are we using current_ts?)
...
models.1 = c(#d and D
           AICc(Arima(housing_ts,order=c(0,0,0),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(0,1,0),seasonal=list(order=c(0,0,0), period=12))), #Best: d=1, D=0
           AICc(Arima(housing_ts,order=c(0,0,0),seasonal=list(order=c(0,1,0), period=12))),
           AICc(Arima(housing_ts,order=c(0,1,0),seasonal=list(order=c(0,1,0), period=12)))
           )
models.1
min(models.1)

models.2 = c(#p and q
           AICc(Arima(housing_ts,order=c(0,1,0),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(0,1,1),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(0,1,2),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(0,1,3),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(0,1,4),seasonal=list(order=c(0,0,0), period=12))),
           
           AICc(Arima(housing_ts,order=c(1,1,0),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(1,1,1),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(1,1,2),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(1,1,3),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(1,1,4),seasonal=list(order=c(0,0,0), period=12))),
           
           AICc(Arima(housing_ts,order=c(2,1,0),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(2,1,1),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(2,1,2),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(2,1,3),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(2,1,4),seasonal=list(order=c(0,0,0), period=12))),
           
           AICc(Arima(housing_ts,order=c(3,1,0),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(3,1,1),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(3,1,2),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(0,0,0), period=12))), #Best: p=q=3
           AICc(Arima(housing_ts,order=c(3,1,4),seasonal=list(order=c(0,0,0), period=12))),
           
           AICc(Arima(housing_ts,order=c(4,1,0),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(4,1,1),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(4,1,2),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(4,1,3),seasonal=list(order=c(0,0,0), period=12))),
           AICc(Arima(housing_ts,order=c(4,1,4),seasonal=list(order=c(0,0,0), period=12)))
)
models.2
min(models.2)

models.3 = c(#P and Q
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(0,0,0), period=12))),
          #AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(0,0,1), period=12))),
          #AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(0,0,2), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(0,0,3), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(0,0,4), period=12))), #Best: P=0, Q=4 
          
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(1,0,0), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(1,0,1), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(1,0,2), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(1,0,3), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(1,0,4), period=12))),
          
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(2,0,0), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(2,0,1), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(2,0,2), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(2,0,3), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(2,0,4), period=12))),
          
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(3,0,0), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(3,0,1), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(3,0,2), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(3,0,3), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(3,0,4), period=12))),
          
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(4,0,0), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(4,0,1), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(4,0,2), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(4,0,3), period=12))),
          AICc(Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(4,0,4), period=12)))
)
models.3
min(models.3) #lower AICC obtained
```
...
tsdiag(final.model)
jarque.bera.test(final.model$residuals) #Not a great result
...
tsdiag(final.model2)
jarque.bera.test(final.model2$residuals) #Not a great result

#Final model 3
final.model3<- Arima(housing_ts,order=c(3,1,3),seasonal=list(order=c(0,0,4), period=12))
summary(final.model3)
plot(final.model3$residuals)
tsdiag(final.model3)
jarque.bera.test(final.model3$residuals) #Not a great result
...
fcst.fm3=forecast(final.model3, h=24)
plot(fcst.fm3)
```
...
#Final model 1
final.model.predict = arima(arima.train, order = c(0,0,12))
arima.predict = predict(final.model.predict, 12)
sqrt(mean((arima.predict$pred - arima.test)^2, na.rm=TRUE)) # Validation: test error  RMSE
...
#Final model 3 (lower RMSE)
final.model3.predict = arima(arima.train, order=c(3,1,3),seasonal=list(order=c(0,0,4), period=12))
arima.predict = predict(final.model3.predict, 12)
sqrt(mean((arima.predict$pred - arima.test)^2, na.rm=TRUE)) # Validation: test error  RMSE
```
...
getrmse(current_ts,h=12,order=c(0,0,12))
#Final model 2
getrmse(housing_ts,h=12,order=c(12,1,12))
#Final model 3
getrmse(housing_ts,h=12,order=c(3,1,3),seasonal=list(order=c(0,1,4), period=12))
```
...
summary(auto.model)
AICc(auto.model) #Worst AICC than our models
...
tsdisplay(residuals(final.model3), lag.max=15, main='Final Model 3 Residuals')
```
