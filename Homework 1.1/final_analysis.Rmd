...
plot_imdb_vs_best_pic <-
  ggplot(movies, aes(x = best_pic_win, y = imdb_rating*10, fill = best_pic_win)) +
  geom_boxplot() +
  theme_minimal() +
  theme(legend.position = "none") +
...
plot_combined_best_pic <-
  ...
  labs(title = "comparison of the score for awarded and non-awarded movies (Box plot)", x = "", y="", fill="")+
  theme(plot.title = element_text(hjust = 0.5))
...
We can see that, for the three sources of score, awarded movies are reviewed more positively. 
...
plot_audience_vs_best_dir <-
  ...
  geom_boxplot() +
  theme(legend.position = "none") +
  labs(title = "Audience", x = "Awarded director", y = "Score")+
  ylim(0,100)
...
plot_critics_vs_best_dir <-
  ...
  geom_boxplot() +
  theme(legend.position = "none") +
  labs(title = "Critics", x = "Awarded director", y = "Score")+
  ylim(0,100)
#IMDB score vs Best_dir_win
plot_imdb_vs_best_dir <-
  ggplot(movies, aes(x = best_dir_win, y = imdb_rating*10, fill = best_dir_win)) +
  geom_boxplot() +
  theme(legend.position = "none") +
  labs(title = "IMDB", x = "Awarded director", y = "Score")+
  ylim(0,100)
#Combine the plots...
plot_combined_best_dir <-
  ...
  labs(title = "Score comparison for movies w/ or w/o an awarded director (Box plot)", x = "", y="", fill="")+
  theme(plot.title = element_text(hjust = 0.5))

plot_combined_best_dir
```

If we now compare the score of movies that have a director that has an award with those that do not, we can tell that the former receive a higher score.
...
plot_audience_vs_best_actor <-
  ...
  theme_minimal() +
  theme(legend.position = "none") +
  labs(title = "Audience", x = "Awarded actor", y = "Score")+
  ylim(0,100)
#Critics score vs Best_dir_win
plot_critics_vs_best_actor <-
  ...
  theme_minimal() +
  theme(legend.position = "none") + 
  labs(title = "Critics", x = "Awarded actor", y = "Score")+
  ylim(0,100)
#IMDB score vs Best_dir_win
plot_imdb_vs_best_actor <-
  ggplot(movies,
         aes(x = best_actor_win, y = imdb_rating*10, fill = best_actor_win)) +
  geom_boxplot() +
  theme_minimal() +
  theme(legend.position = "none") +
  labs(title = "IMDB", x = "Awarded actor", y = "Score")+
  ylim(0,100)
#Combine the plots...
plot_combined_best_actor <-
  ...
  labs(title = "Score comparison for movies w/ or w/o an awarded actor (Box plot)", x = "", y="", fill="")+
  theme(plot.title = element_text(hjust = 0.5))

plot_combined_best_actor
```

However, if we compare the score of movies that star an actor that has been awarded with those that do not, we can see that there is not a big difference in the score each group receives.
...
plot_audience_vs_best_actress <-
  ...
  theme_minimal() +
  theme(legend.position = "none") +
  labs(title = "Audience", x = "Awarded actress", y = "Score")+
  ylim(0,100)
...
plot_critics_vs_best_actress <-
  ...
  theme_minimal() +
  theme(legend.position = "none") +
  labs(title = "Critics", x = "Awarded actress", y = "Score")+
  ylim(0,100)

#IMDB score vs Best_dir_win
plot_imdb_vs_best_actress <-
  ggplot(movies,
         aes(x = best_actress_win, y = imdb_rating*10, fill = best_actress_win)) +
  geom_boxplot() +
  theme_minimal() +
  theme(legend.position = "none") +
  labs(title = "IMDB", x = "Awarded actress", y = "Score")+
  ylim(0,100)
...
plot_combined_best_actress <-
  ...
  labs(title = "Score comparison for movies w/ or w/o an awarded actress (Box plot)", x = "", y="", fill="")+
  theme(plot.title = element_text(hjust = 0.5))

plot_combined_best_actress
```

A similar result is obtained if we compare the scores of movies where an awarded actress played a role and those where she did not. The scores are similar for both groups of movies.
