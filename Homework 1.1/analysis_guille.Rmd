...
```{r}
ggplot(movies, aes(fill = thtr_rel_date)) + geom_smooth(aes(x = thtr_rel_date, y = imdb_num_votes)) + geom_point(aes(x = thtr_rel_date, y = imdb_num_votes)) + theme_minimal() + xlab("Date") + ylab("# of Votes") + ggtitle("# of votes rating movies over the years") # + scale_fill_discrete(name = "Decade", labels=c("70's","80's","90's","00's","10's"))
```
...
ggplot(movies, aes(fill = thtr_rel_date)) +
  geom_smooth(aes(x = thtr_rel_date, y = imdb_rating)) +
  theme_minimal() +
  xlab("Date") +
  ylab("Rating") +
  ylim (0, 10) +
