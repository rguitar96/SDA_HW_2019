...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ best_pic_movies <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(movies, }\KeywordTok{c}\NormalTok{(best_pic_nom }\OperatorTok{==}\StringTok{ "yes"}\NormalTok{))}
...
\StringTok{   }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Best movies with another award"}\NormalTok{) }\OperatorTok{+}
\StringTok{   }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{20}\NormalTok{, }\DataTypeTok{hjust =} \FloatTok{0.5}\NormalTok{)) }\OperatorTok{+}
...
\StringTok{   }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Best movies with best actor"}\NormalTok{) }\OperatorTok{+}
...
\StringTok{   }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Best movies with best actress"}\NormalTok{) }\OperatorTok{+}
\StringTok{   }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{20}\NormalTok{, }\DataTypeTok{hjust =} \FloatTok{0.5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{   }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Best movies with best director"}\NormalTok{) }\OperatorTok{+}
\StringTok{   }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{20}\NormalTok{, }\DataTypeTok{hjust =} \FloatTok{0.5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{final_analysis_files/figure-latex/unnamed-chunk-25-2.pdf}
